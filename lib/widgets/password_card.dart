...
class _PasswordCardState extends State<PasswordCard> {
  ...
  void _deletePassword() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            'Sei sicuro di voler eliminare la password per "${widget.entry.title}"?',
          ),
          actions: <Widget>[
            TextButton(
    ...
    if (confirmed == true) {
      ...
      widget
          .onDelete(); // Esegue il callback per aggiornare la lista nella Dashboard
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: [
              widget.entry.color.withOpacity(0.20),
              widget.entry.color.withOpacity(0.15),
              Colors.transparent,
            ],
          ),
        ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _DetailRow(
                    ...
                    text: widget.entry.username.isNotEmpty
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () =>
                              _copyToClipboard(widget.entry.password, context),
